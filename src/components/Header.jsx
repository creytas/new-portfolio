...
const HeaderBar = ({isLight, setIsLight}) =>{
    return(
        <header className="w-screen flex justify-end">
            ...
            <div className={`w-3/4 md:w-screen min-h-[74px] flex justify-end md:items-start p-4 md:pr-16 md:fixed ${isLight ? "md:bg-secondary/70 md:hover:bg-secondary/95" : "md:bg-alt-navy/70 md:hover:bg-navy/95"} md:z-20`}>
